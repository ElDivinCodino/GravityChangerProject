...
public class MovePlayer : MonoBehaviour
{
    ...
    private void Look()
    {
        ...
        head.transform.localRotation = Quaternion.Euler(xRotation, desiredX, 0);
    ...
    {
        float invertMovement = gameManager.IsGravityInverted() ? -1 : 1;
        ...
        float xMag = invertMovement * magnitude * Mathf.Cos(v * Mathf.Deg2Rad);
